...
@WebServlet(name = "sunday", urlPatterns = "/sunday")
public class sunday extends HttpServlet {
...
//        roll = request.getParameter("usrrollno");
        ...
        try {
            ...
            PreparedStatement st=con.prepareStatement("SELECT * FROM currentmovies where day='Sunday'");
