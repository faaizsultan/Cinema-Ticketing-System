...
@WebServlet(name = "saturday", urlPatterns = "/saturday")
public class saturday extends HttpServlet {
...
//        roll = request.getParameter("usrrollno");
        ...
        try {
            ...
            PreparedStatement st=con.prepareStatement("SELECT * FROM currentmovies where day='Saturday'");
